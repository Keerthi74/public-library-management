--Kerthana Cheruvu
--G01160202
--Final Project Creation of Entities
...
create table library."Material"(
	...
	constraint fk_catalog
		...
		references library."Catalog"(Catalog_ID),
	constraint fk_genre
...
create table library."Borrow"(
	...
	constraint fk_material
		...
		references library."Material"(Material_ID),
...
create table library."Authorship"(
...
insert into library."Catalog"(Catalog_ID, Name, Location) 
values(1,'Books', 'A1.1'),
(2, 'Magazines', 'B2.1'),
(3, 'E-Books', 'C3.1'),
(4, 'Audiobooks', 'D4.1'),
...
insert into library."Genre"(Genre_ID, Name, Description)
values(1, 'General Fiction', 'Literary works with a focus on character and plot development,
exploring various themes and human experiences.'),
(2, 'Mystery & Thriller', 'Suspenseful stories centered around crime, investigation, or
espionage with an emphasis on tension and excitement.'),
(3, 'Science Fiction & Fantasy', 'Imaginative works that explore alternate realities, futuristic
concepts, and magical or supernatural elements.'),
(4, 'Horror & Suspense', 'Stories designed to evoke fear, unease, or dread, often featuring
supernatural or psychological elements.'),
(5, 'Dystopian & Apocalyptic', 'Depictions of societies in decline or collapse, often exploring
themes of political and social oppression or environmental disaster.'),
(6, 'Classics', 'Enduring works of literature that have stood the test of time, often
featuring rich language and complex themes.'),
(7, 'Historical Fiction','Fictional stories set in the past, often based on real historical events
or figures, and exploring the customs and experiences of that time.'),
...
insert into library."Member"(Member_ID, Name, Contact_Info, Join_Date)
...
insert into library."Staff"(Staff_ID, Name, Contact_Info, Job_Title, Hire_Date)
...
insert into library."Borrow"(Borrow_ID, Material_ID, Member_ID, Staff_ID, Borrow_Date, Due_Date, Return_Date)
...
insert into library."Author"(Author_ID, Name, Birth_Date, Nationality)
